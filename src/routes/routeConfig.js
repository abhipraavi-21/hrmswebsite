export const ROUTES = {
  ...
  adminWebsiteContent: "/admin/website-content",
  adminPages: "/admin/pages",
  adminSeo: "/admin/seo",
  adminBlogs: "/admin/blogs",
  adminLearn: "/admin/learn",
  adminCompliance: "/admin/compliance-guides",
  adminFaqs: "/admin/faqs",
  adminMedia: "/admin/media-library",
  adminDemoRequests: "/admin/demo-requests",
  adminContactEnquiries: "/admin/contact-enquiries",
  adminNewsletter: "/admin/newsletter-subscribers",
  adminBulkEmail: "/admin/bulk-email",
  adminRedirects: "/admin/redirect-manager",
  adminSitemap: "/admin/sitemap-manager",
