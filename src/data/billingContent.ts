...
export const BILLING_PRODUCT_CONTENT: Record<string, BillingProductContent> = {
  hrms: {
    ...
    faqItems: [
      ...
      {
        question: "Can I choose 1 year, 2 year or 3 year renewal terms?",
        answer:
          "Yes. HRMS checkout supports 1 year, 2 year and 3 year billing terms. The 1 year term has no default discount, 2 years applies 10%, and 3 years applies 20% before setup charges and coupons.",
      },
      {
        question: "How are setup charges, coupons and totals calculated?",
        answer:
          "The backend calculates the subscription amount first, applies the selected term discount, adds the one-time setup charge, then applies any valid coupon discount to return the final payable amount.",
      },
    ],
