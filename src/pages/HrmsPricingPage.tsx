...
const fallbackHeroItems = [
  ...
  },
  {
    ...
    value: "Geo, WhatsApp, biometric, assets and recruitment",
    desc: "Optional modules can be layered on top of the yearly HRMS plans.",
    icon: <Coins className="h-4 w-4" />,
  },
];

const hrmsAddonPlans: HrmsAddonPlan[] = [
  {
    name: "Geo Tracking",
    pricing: "\u20B950 per user / month",
    minimumOrIncluded: "Minimum 5 users required",
    details: [
  ...
  },
  {
    ...
    minimumOrIncluded: "Based on selected users",
    details: [
  ...
  },
  {
    ...
    pricing: "\u20B92,000 per machine",
    minimumOrIncluded: "First machine included",
    details: [
  ...
  },
  {
    ...
    pricing: "\u20B91.50 per employee / month",
    minimumOrIncluded: "50 assets included",
    details: [
  ...
  },
  {
    ...
    pricing: "\u20B91,000 per 100 applicants",
    minimumOrIncluded: "10 applicants included",
    details: [
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-5 flex justify-center">
                    <Link
                      to={`${ROUTES.checkoutBase}/hrms?${createSearchParams({
                        plan: plan.slug,
...
function HrmsAddonPlansSection() {
  return (
    <section id="addon-plans" className="bg-surface py-14 sm:py-16 lg:py-20">
      <div className="container-x">
        <div className="mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-white px-4 py-2 text-xs font-bold uppercase tracking-[0.28em] text-primary shadow-sm">
            <Coins className="h-3.5 w-3.5" />
            Add-on plans
          </div>
          <h2 className="mt-4 text-3xl font-black tracking-tight text-ink sm:text-4xl">
            HRMS add-ons for pricing and configuration
          </h2>
          <p className="mt-4 text-base leading-7 text-ink-soft sm:text-lg">
            Add-ons sit on top of the selected HRMS plan and let you extend rollout scope for
            field attendance, alerts, biometric devices, assets and recruitment.
          </p>
        </div>

        <div className="mt-10 rounded-[2rem] border border-primary/15 bg-white p-4 shadow-float sm:p-6">
          <div className="grid gap-4 lg:grid-cols-2 xl:grid-cols-3">
            {hrmsAddonPlans.map((addon) => (
              <article
                key={addon.name}
                className="flex h-full flex-col rounded-[1.5rem] border border-border bg-white p-5 shadow-sm"
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <div className="text-xs font-bold uppercase tracking-[0.24em] text-primary">
                ...
                <div className="mt-5 rounded-[1.25rem] border border-primary/15 bg-primary-soft/35 p-4">
                  <div className="text-xs font-bold uppercase tracking-[0.24em] text-primary">
                    Pricing
                  </div>
                  <div className="mt-2 text-lg font-black text-ink">{addon.pricing}</div>
                </div>

                <div className="mt-4 rounded-[1.25rem] border border-border bg-surface/35 p-4">
                  <div className="text-xs font-bold uppercase tracking-[0.24em] text-primary">
                    Minimum / Included
                  </div>
                  <div className="mt-2 text-sm font-semibold leading-6 text-ink">
                    {addon.minimumOrIncluded}
                  </div>
                </div>

                <div className="mt-4 space-y-3">
                  {addon.details.map((detail) => (
                    <div key={detail} className="flex items-start gap-3 rounded-2xl bg-surface/45 p-3">
                      <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-primary" />
                      <span className="text-sm leading-6 text-ink-soft">{detail}</span>
                    </div>
                  ))}
                </div>
              </article>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="overflow-x-hidden">
        ...
        <section id="feature-comparison" className="bg-surface/70 py-14 sm:py-16 lg:py-20">
          <div className="container-x">
