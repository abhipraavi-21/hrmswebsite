          ...
          <div className="site-container">
            <ScrollReveal className="mx-auto max-w-5xl text-center">
              ...
              <p className="mx-auto mt-5 max-w-4xl text-lg leading-8 text-ink-soft sm:text-xl">
                Explore simple, practical articles on attendance, payroll, leave, recruitment,
                performance, and HR automation. Written for Indian businesses, startups, and
                growing teams who want to build better workplaces with the right HR knowledge and
