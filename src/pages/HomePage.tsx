          ...
          <div className="container-x py-10 sm:py-12 lg:py-16">
            <div className="mx-auto max-w-5xl">
              <div className="mx-auto max-w-4xl text-center">
                ...
                <h1 className="mt-4 text-balance text-4xl font-black leading-[1.03] tracking-[-0.04em] text-ink sm:text-5xl lg:text-[4.35rem]">
                  Business Management Software That Brings HR, Assets, and Communication Together
                </h1>

                <h2 className="mx-auto mt-4 max-w-3xl text-2xl font-semibold tracking-tight text-primary sm:text-3xl">
                  One Platform. Three Enterprise Solutions. A Single Trusted Brand.
                </h2>

                <p className="mx-auto mt-4 max-w-2xl text-justify hyphens-auto text-lg leading-8 text-ink-soft sm:text-xl">
