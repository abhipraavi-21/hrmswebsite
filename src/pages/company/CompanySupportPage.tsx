        ...
        <section className="relative overflow-hidden py-12 sm:py-16 lg:py-20">
          ...
          <div className="site-container grid gap-10 lg:grid-cols-12 lg:items-center">
            <ScrollReveal className="lg:col-span-7">
              ...
              <div className="mt-7 max-w-2xl rounded-[1.75rem] border border-border bg-white p-4 shadow-card">
              ...
              <div className="soft-card relative overflow-hidden p-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {[
                    ...
                    <div key={item.title} className="rounded-[1.4rem] border border-border bg-[#f4f8ff] p-4">
