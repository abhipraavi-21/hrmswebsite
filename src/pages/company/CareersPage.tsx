  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="careers-page">
        <section className="careers-hero hero-gradient relative overflow-hidden scroll-mt-24">
          ...
          <div className="container-x grid gap-4 py-5 lg:grid-cols-12 lg:items-start lg:py-6">
                ...
                <div className="relative overflow-hidden rounded-[2rem] border border-border bg-white p-4 shadow-float">
                  <div className="grid gap-2 md:grid-cols-[1.05fr_0.95fr]">
                    <div className="rounded-[1.5rem] border border-border bg-surface p-4">
                      ...
                      <div className="mt-2 rounded-[1.25rem] bg-primary-soft/40 p-3">
        ...
        <section className="bg-surface py-8 md:py-12">
          <div className="container-x grid gap-4 lg:grid-cols-12 lg:items-start">
            <div className="lg:col-span-5">
              ...
              <div className="mt-5 rounded-[1.5rem] border border-border bg-white p-5 shadow-card">
                <div className="text-xs font-bold uppercase tracking-[0.22em] text-primary">
        ...
        <section className="py-8 md:py-12">
          <div className="container-x">
            ...
            <ol className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-7">
                  ...
                  <TabsList className="flex h-auto w-full gap-2 overflow-x-auto bg-transparent p-0 lg:grid lg:grid-cols-1 lg:overflow-visible">
                    {departments.map((department, index) => (
                      <TabsTrigger
                        key={department.id}
                        value={department.id}
                        className="min-w-[12rem] justify-start rounded-2xl border border-border bg-white px-4 py-2.5 text-left text-sm font-semibold text-ink shadow-card data-[state=active]:border-primary data-[state=active]:bg-primary-soft data-[state=active]:text-primary lg:min-w-0"
                      ...
                      <div className="rounded-[1.75rem] border border-border bg-white p-6 shadow-card">
                        <div className="flex items-start justify-between gap-4">
                          <div>
                            ...
                            <h3 className="mt-1 text-2xl font-bold text-ink">{department.title}</h3>
                        ...
                        <div className="mt-4 rounded-[1.5rem] border border-primary/20 bg-primary-soft/30 p-4 text-sm leading-6 text-ink">
        ...
        <section id="openings" className="bg-surface py-8 md:py-12 scroll-mt-24">
          <div className="container-x">
            <SectionHeading
        ...
        <section className="bg-surface py-8 md:py-12">
          <div className="container-x">
            ...
            <ol className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-6">
        ...
        <section id="apply" className="py-8 md:py-12 scroll-mt-24">
          <div className="container-x">
            <div className="rounded-[2.25rem] border border-border bg-white p-6 shadow-float md:p-8">
              <div className="grid gap-5 lg:grid-cols-12 lg:items-start">
                <div className="lg:col-span-4">
                  ...
                  <div className="mt-4 rounded-[1.5rem] border border-primary/20 bg-primary-soft/30 p-5">
                    <div className="text-xs font-bold uppercase tracking-[0.22em] text-primary">
                      Important note
                    </div>
                    <p className="mt-3 text-sm leading-7 text-ink">
                  ...
                  <div className="mt-3 rounded-[1.5rem] border border-border bg-surface p-5">
                    <div className="text-xs font-bold uppercase tracking-[0.22em] text-primary">
                      Form status
                    </div>
