      ...
      <main>
        ...
        <section className="bg-surface py-16 lg:py-20">
          <div className="container-x">
            ...
            <div className="mt-6 max-w-5xl space-y-4 text-sm leading-7 text-justify text-ink-soft">
              <p>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              {[
                {
                  title: "Attendance",
                  description: "Review daily check-ins and workforce presence without opening separate tools.",
                },
                {
                  title: "Leave",
                  description: "Track requests, approvals and balances from the same connected workspace.",
                },
                {
                  title: "Reports",
                  description: "Keep summaries and workforce insights ready for managers when decisions are needed.",
                },
              ].map((item) => (
