...
const pageTitle = "Secure HRMS Software in Pune | Altroz HR Security";
const pageDescription =
  "Protect employee records, payroll data, attendance, documents, compliance information, and HR reports with secure role-based access from Altroz HR.";
...
const faqItems = [
  {
    q: "Is Altroz HR secure?",
    a: "Altroz HR is designed to help organizations manage employee and HR information through centralized storage, controlled user access, and role-based permissions. Exact security capabilities depend on the deployed configuration, hosting environment, and enabled features.",
  },
  {
  ...
  {
    q: "Is Altroz HR suitable for multi-branch organizations?",
          ...
          <div className="container-x grid gap-10 py-12 lg:grid-cols-12 lg:items-start lg:py-16">
            <div className="lg:col-span-6 fade-up motion-reduce:animate-none">
              ...
              <h1 className="mt-4 max-w-2xl text-4xl font-bold leading-tight text-ink sm:text-5xl">
                Protect Your Employee Data with Altroz HR
              </h1>
              <p className="mt-4 max-w-xl text-base text-ink-soft">
                Employee information is one of your organization&apos;s most valuable and
                confidential business assets. Altroz HR helps protect employee records, payroll
          ...
          <div className="container-x grid gap-8 lg:grid-cols-12 lg:items-start">
            <div className="lg:col-span-6">
              <SectionHeading
                ...
                description="Payroll records contain sensitive employee and financial information. Altroz HR helps organizations limit payroll access to authorized HR, payroll, finance, and management users."
              />
          ...
          <div className="container-x grid gap-8 lg:grid-cols-12 lg:items-start">
            <div className="lg:col-span-5">
              <SectionHeading
                ...
                title="Why choose Altroz HR for secure HR management?"
              ...
              <div className="grid gap-8 lg:grid-cols-12 lg:items-center">
                <div className="lg:col-span-7">
                  ...
                  <h2 className="mt-2 text-3xl font-bold tracking-tight text-ink sm:text-4xl">
                    Protect Your HR Data with Altroz HR
                  </h2>
