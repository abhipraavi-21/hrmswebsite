...
const reportCategories: ReportCategory[] = [
  ...
  },
  {
    ...
    note: "Attendance reporting mirrors the live attendance workflows already present in Altroz HR.",
  },
  {
    id: "payroll",
  ...
  },
  {
    ...
    note: "Compliance reporting is limited to the statutory items surfaced by the current Altroz HR product pages.",
  },
  {
    id: "asset",
    label: "Asset Reports",
...
const faqItems = [
  ...
  {
    q: "Which HR Reports are available in Altroz HR?",
    a: "Altroz HR can provide employee, attendance, payroll, leave, recruitment, performance, compliance, asset, expense, visitor, and exit management reports depending on the modules enabled for the organization.",
  },
  {
...
export default function HrReportsPage() {
  usePageMeta(
    "HR Reports and Analytics Software in Pune | Altroz HR",
    "Generate employee, attendance, payroll, leave, compliance, recruitment, performance, expense, and asset reports with Altroz HR reporting software.",
  );
      ...
      <main>
          ...
          <div className="container-x grid gap-10 py-10 lg:grid-cols-12 lg:items-start lg:py-12">
            <div className="lg:col-span-8 fade-up motion-reduce:animate-none">
              ...
              <h1 className="mt-4 max-w-2xl text-4xl font-bold leading-tight text-ink sm:text-5xl">
                Generate Accurate HR Reports with Altroz HR
              </h1>
              <p className="mt-4 max-w-xl text-base leading-7 text-justify hyphens-auto text-ink-soft">
                Make faster and more informed business decisions with powerful HR reports and
                real-time workforce analytics.
              </p>
              <p className="mt-4 max-w-xl text-base leading-7 text-justify hyphens-auto text-ink-soft">
                Altroz HR helps you generate employee, attendance, payroll, leave, compliance,
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  { label: "HR Reporting", value: "One central system" },
                ].map((item) => (
          ...
          <div className="container-x grid gap-8 lg:items-center">
            <div>
              ...
              <div className="mt-4 space-y-4 text-ink-soft">
                ...
                <p>
                Altroz HR replaces manual reporting processes and scattered Excel sheets with
                one centralized reporting system. With Altroz HR, organizations can access
          ...
          <div className="container-x grid gap-8 lg:items-center">
            <div>
              <SectionHeading
                ...
                description="Altroz HR allows organizations to view reports based on branches, departments, teams, and business locations."
              />
        ...
        <section className="py-20">
          <div className="container-x">
            <SectionHeading
              eyebrow="Benefits"
              title="Benefits of Altroz HR reports"
        ...
        <section className="bg-surface py-20">
          <div className="container-x">
            <SectionHeading
              ...
              title="Why choose Altroz HR for HR reporting?"
