        ...
        <thead className="bg-surface">
          <tr>
            {headers.map((header) => (
              <th
                key={header}
                className="whitespace-nowrap px-4 py-3 text-xs font-bold uppercase tracking-[0.18em] text-primary"
              >
                {header}
              </th>
            ))}
        ...
        <tbody>
          {rows.map((row) => (
            <tr key={row.join("-")} className="border-t border-border/70">
              {row.map((cell) => (
                <td key={cell} className="whitespace-nowrap px-4 py-3 text-ink">
                  {cell}
                </td>
              ))}
            </tr>
