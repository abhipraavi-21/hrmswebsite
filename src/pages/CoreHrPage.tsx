        ...
        >
          ...
          <div className="container-x py-4 lg:py-6">
            <div className="mx-auto max-w-4xl px-6 py-6 text-center">
              ...
              <p className="mx-auto mt-2 max-w-3xl text-base text-ink-soft">
            ...
            <div className="relative mx-auto mt-8 max-w-5xl overflow-hidden rounded-[2.25rem] border border-border bg-white shadow-float">
              <div className="relative flex min-h-[38vh] items-center overflow-hidden bg-white sm:min-h-[42vh] lg:min-h-[46vh]">
                <img
                  src={heroImages.desktop}
                  alt="Darwinbox Core HR dashboard hero"
                  className="hidden h-full w-full object-contain bg-white p-2 md:block lg:p-3"
                  loading="eager"
                ...
                <img
                  ...
                  className="h-full w-full object-contain bg-white p-2 md:hidden"
                  loading="eager"
                  referrerPolicy="no-referrer"
                />
              </div>
          ...
          <div className="container-x">
            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-12 lg:items-start">
              ...
              <div className="flex flex-col gap-4 lg:col-span-9">
                <article className="soft-card p-0 w-full">
