...
export const hrmsLinks = [
  { label: "Attendance", desc: "GPS, biometric & shifts", href: ROUTES.attendance },
...
export const emailLinks = [
  { label: "Campaigns", desc: "Send at scale", href: ROUTES.bookDemo },
  { label: "Templates", desc: "Drag & drop builder", href: ROUTES.learn },
  { label: "Contacts", desc: "Segmentation & lists", href: ROUTES.customers },
  { label: "Analytics", desc: "Open & click tracking", href: ROUTES.analytics },
  { label: "Automation", desc: "Drip workflows", href: ROUTES.automation },
];
