      ...
      >
        ...
        <nav className="flex w-fit flex-wrap items-center justify-center gap-1 pl-3 sm:pl-4 lg:absolute lg:left-1/2 lg:top-1/2 lg:z-10 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:pl-0 lg:flex-nowrap">
          ...
          >
            ...
            <div
              className={`absolute left-0 top-full z-50 w-[min(18rem,calc(100dvw-2rem))] pt-3 origin-top-left transition-[opacity,transform] duration-200 ease-out ${
                openMenu === "solutions"
                  ...
                  {solutionMenuItems.map((item) => (
                      <li key={item.label}>
                        <Link
                          ...
                          className="group block rounded-lg px-2 py-1.5 text-sm whitespace-nowrap text-ink transition-colors hover:bg-white/70 hover:text-primary"
                        >
          ...
          >
            ...
            <div
              className={`absolute left-0 top-full z-50 w-[min(900px,calc(100dvw-2rem))] origin-top-left pt-3 transition-[opacity,transform] duration-[240ms] ease-out ${
                openMenu === "features"
                  ? "pointer-events-auto translate-y-0 scale-100 opacity-100"
            ...
            >
              <div aria-hidden="true" className="h-3" />
              <div className="popup-blue-surface relative max-w-[calc(100dvw-2rem)] overflow-hidden rounded-[1.5rem] border border-white/70 p-4 shadow-[0_28px_70px_rgba(11,92,255,0.16)] backdrop-blur-xl ring-1 ring-white/60 md:p-6">
                <div className="pointer-events-none absolute inset-x-0 top-0 h-[3px] popup-blue-band" />
          ...
          >
            ...
            <div
              className={`absolute left-0 top-full z-50 w-[min(280px,calc(100dvw-2rem))] origin-top-left pt-3 transition-[opacity,transform] duration-200 ease-out ${
                openMenu === "resources"
                  ? "pointer-events-auto translate-y-0 scale-100 opacity-100"
                  : "pointer-events-none translate-y-2 scale-[0.98] opacity-0"
              }`}
            >
              <div aria-hidden="true" className="h-3" />
              <div className="popup-blue-surface relative max-w-[calc(100dvw-2rem)] overflow-hidden rounded-2xl border border-border p-6 shadow-pop backdrop-blur-sm">
                <div className="pointer-events-none absolute inset-x-0 top-0 h-[3px] popup-blue-band" />
          ...
          >
            ...
            <div
              className={`absolute right-0 top-full z-50 w-[min(600px,calc(100dvw-2rem))] origin-top-right pt-3 transition-[opacity,transform] duration-200 ease-out ${
                openMenu === "company"
                  ? "pointer-events-auto translate-y-0 scale-100 opacity-100"
            ...
            >
              <div aria-hidden="true" className="h-3" />
              <div className="popup-blue-surface relative max-w-[calc(100dvw-2rem)] overflow-hidden rounded-2xl border border-border p-4 shadow-pop backdrop-blur-sm md:p-5">
                <div className="pointer-events-none absolute inset-x-0 top-0 h-[3px] popup-blue-band" />
