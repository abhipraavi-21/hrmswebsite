    ...
    <>
      ...
      >
        <Routes>
          ...
          <Route path="/attendance-management" element={<Navigate to={ROUTES.attendanceManagement} replace />} />
          ...
          <Route path="/integrations/asset-management" element={<Navigate to={ROUTES.assetManagement} replace />} />
          ...
          <Route path="/products/recruitment" element={<Navigate to={ROUTES.recruitment} replace />} />
          <Route path="/resources/learning" element={<Navigate to={ROUTES.learn} replace />} />
          <Route path="/solutions/industry" element={<Navigate to={ROUTES.industrySolutions} replace />} />
          <Route path="/solutions/workforce-management" element={<Navigate to={ROUTES.workforce} replace />} />
