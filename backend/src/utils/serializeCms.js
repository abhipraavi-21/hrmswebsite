...
export function serializeItem(item) {
  return {
    ...
    imageAlt: normalizeText(item.image_alt),
...
export function serializeSection(section) {
  ...
  return {
    ...
    imageAlt: normalizeText(section.image_alt),
    backgroundImageUrl: normalizeText(section.background_image_url),
    backgroundImageAlt: normalizeText(section.background_image_alt),
...
export function serializePage(page) {
  ...
  return {
    ...
    ogImageAlt: normalizeText(page.og_image_alt),
    ...
    resourcePage: page.resourcePage
      ? {
          ...
          featuredImageAlt: normalizeText(page.resourcePage.featured_image_alt),
